$(document).ready(function() {
	...
	$(".portfolio_item").each(function(i) {
		$(this).find(".portfolio_item_info a").attr("href", "#work_"+i);
		$(this).find(".portfolio_popup_content").attr("id", "work_"+i);
		var bg = $(this).find(".portfolio_photo").css('background-image');
    bg = bg.replace('url(','').replace(')','').replace(/\"/gi, "");
    $(this).find(".portfolio_popup_content img").attr("src", bg);
	});
